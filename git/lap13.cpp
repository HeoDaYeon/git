...
public:
	...
	//virtual void f() = 0; // { std::cout << "base::f()\t"; } // 순수가상함수
...
//
//public:
//	derived(int length=10, const std::string& n="derived") : base{n},
//		a{new int[length]} {  }
...
{ 
	...
	//if (discount < simple)
	//{
	//	std::cout << "Discount item is cheaper.\n";
